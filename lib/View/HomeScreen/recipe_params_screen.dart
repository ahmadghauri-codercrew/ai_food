...
class _RecipeParamScreenState extends State<RecipeParamScreen> {
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    kitchenProvider.addKitchenResources.isEmpty? CustomRecipesSelection(
                                      widget: chipWidget(
                                    ...
                                    ): DisableRecipeSelect(recipeText: "Preferred protein"),
                                    SizedBox(height: height > 720 ? height * 0.02 : height * 0.01),
                                    ...
                                    delicacyProvider.addRegionalDelicacy.isEmpty &&proteinProvider.addProtein.isEmpty?  CustomRecipesSelection(
                                      widget: chipWidget(
                                    ...
                                    ):DisableRecipeSelect(recipeText: "Desserts"),
                                    SizedBox(height: height > 720 ? height * 0.02 : height * 0.01),
  ...
  Future generateRecipe({style, allergy, dietary, regional, kitchen}) async {
    ...
    final kitchenResources = kitchenProvider.addKitchenResources.isNotEmpty
        ? "&includeIngredients=${kitchenProvider.addKitchenResources.toString().substring(1, kitchenProvider.addKitchenResources.toString().length - 1)}"
        : "";

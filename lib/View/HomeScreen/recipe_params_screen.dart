                      ...
                      Column(
                        ...
                        children: [
                          ...
                          CustomRecipesSelection(
                            widget: chipWidget(details: allergiesProvider.addAllergies),
                          ...
                          CustomRecipesSelection(
                            widget: chipWidget(details: restrictionsProvider.addDietaryRestrictions),
                            recipeText: "Dietary restrictions",
                            showListDataInChip: restrictionsProvider.addDietaryRestrictions,
                            onTap: () {
                          ...
                          CustomRecipesSelection(
                            widget: chipWidget(details: proteinProvider.addProtein),
                          ...
                          //here are the Regional delicacy
                          CustomRecipesSelection(
                            widget: chipWidget(details: delicacyProvider.addRegionalDelicacy),
                            recipeText: "Regional delicacy",
                            showListDataInChip: delicacyProvider.addRegionalDelicacy,
                            onTap: () {
                          ...
                          CustomRecipesSelection(
                            widget: chipWidget(details: kitchenProvider.addKitchenResources),
                            recipeText: "Kitchen resources",
                            showListDataInChip: kitchenProvider.addKitchenResources,
                            onTap: () {
